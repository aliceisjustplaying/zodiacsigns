import type { SignsRecord } from './types.js';
...
export const SIGNS: SignsRecord = {
  sun: [
    ...
    { post: '3l3lfxkifbh27', label: 'aaa-sun-sagittarius', displayLabel: '♐\u202F☀️', enDesc: 'Sagittarius', brDesc: 'Sagitário' },
    { post: '3l3lfxqfxie2n', label: 'aaa-sun-capricorn', displayLabel: '♑\u202F☀️', enDesc: 'Capricorn', brDesc: 'Capricórnio' },
  ...
  moon: [
    ...
    { post: '3l3lhjjlnyg2j', label: 'bbb-moon-sagittarius', displayLabel: '♐\u202F🌙', enDesc: 'Sagittarius', brDesc: 'Sagitário' },
    { post: '3l3lhjqpcmb2r', label: 'bbb-moon-capricorn', displayLabel: '♑\u202F🌙', enDesc: 'Capricorn', brDesc: 'Capricórnio' },
  ...
  rising: [
    ...
    { post: '3l3lhu2qoyf2h', label: 'ccc-rising-scorpio', displayLabel: '♏\u202F⬆️', enDesc: 'Scorpio', brDesc: 'Escorpião' },
    { post: '3l3lhu77pvx27', label: 'ccc-rising-sagittarius', displayLabel: '♐\u202F⬆️', enDesc: 'Sagittarius', brDesc: 'Sagitário' },
    { post: '3l3lhueqe5l2n', label: 'ccc-rising-capricorn', displayLabel: '♑\u202F⬆️', enDesc: 'Capricorn', brDesc: 'Capricórnio' },
